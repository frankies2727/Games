...
export function JoinGame({ onJoin }: JoinGameProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-[#F4F1EA] text-[#2D2D2D] p-4 font-sans selection:bg-[#EAEAEA]">
      <div className="max-w-md w-full bg-white shadow-[8px_8px_0px_#1A1A1A] border-2 border-[#1A1A1A] p-8 space-y-8">
        <div className="text-center space-y-2 border-b-2 border-[#1A1A1A] pb-6">
          <h1 className="text-4xl font-bold tracking-tighter uppercase italic text-[#1A1A1A]">Paper Numbers</h1>
          <p className="text-xs font-mono uppercase tracking-widest text-[#6B6B6B]">Find the numbers or circle the dots!</p>
        </div>
